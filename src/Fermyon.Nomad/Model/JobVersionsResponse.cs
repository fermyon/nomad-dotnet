...
namespace Fermyon.Nomad.Model
{
    ...
    /// JobVersionsResponse
    /// </summary>
    [DataContract(Name = "JobVersionsResponse")]
    public partial class JobVersionsResponse : IEquatable<JobVersionsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobVersionsResponse" /> class.
        /// </summary>
        /// <param name="diffs">diffs.</param>
        ...
        public JobVersionsResponse(List<JobDiff> diffs = default(List<JobDiff>), bool knownLeader = default(bool), long lastContact = default(long), int lastIndex = default(int), string nextToken = default(string), long requestTime = default(long), List<Job> versions = default(List<Job>))
        {
            this.Diffs = diffs;
        ...
        /// Gets or Sets Diffs
        /// </summary>
        [DataMember(Name = "Diffs", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as JobVersionsResponse);
        }

        /// <summary>
        /// Returns true if JobVersionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of JobVersionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobVersionsResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.Diffs == input.Diffs ||
                    this.Diffs != null &&
                    input.Diffs != null &&
                    this.Diffs.SequenceEqual(input.Diffs)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Diffs != null)
                {
                    hashCode = (hashCode * 59) + this.Diffs.GetHashCode();
                }
