...
namespace Fermyon.Nomad.Model
{
    ...
    public partial class CSIVolumeCreateRequest : IEquatable<CSIVolumeCreateRequest>, IValidatableObject
    {
        ...
        public CSIVolumeCreateRequest(string varNamespace = default(string), string region = default(string), string secretID = default(string), List<CSIVolume> volumes = default(List<CSIVolume>))
        {
