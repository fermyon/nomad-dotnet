...
namespace Fermyon.Nomad.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NodeDrainUpdateResponse")]
    public partial class NodeDrainUpdateResponse : IEquatable<NodeDrainUpdateResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeDrainUpdateResponse" /> class.
        /// </summary>
        ...
        public NodeDrainUpdateResponse(int evalCreateIndex = default(int), List<string> evalIDs = default(List<string>), int lastIndex = default(int), int nodeModifyIndex = default(int), long requestTime = default(long))
        {
        ...
        {
            return this.Equals(input as NodeDrainUpdateResponse);
        }

        /// <summary>
        /// Returns true if NodeDrainUpdateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of NodeDrainUpdateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NodeDrainUpdateResponse input)
        {
            if (input == null)
            {
                return false;
