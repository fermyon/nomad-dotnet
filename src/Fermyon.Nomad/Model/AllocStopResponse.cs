...
namespace Fermyon.Nomad.Model
{
    ...
    /// AllocStopResponse
    /// </summary>
    [DataContract(Name = "AllocStopResponse")]
    public partial class AllocStopResponse : IEquatable<AllocStopResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllocStopResponse" /> class.
        /// </summary>
        /// <param name="evalID">evalID.</param>
        /// <param name="index">index.</param>
        public AllocStopResponse(string evalID = default(string), int index = default(int))
        {
            this.EvalID = evalID;
            this.Index = index;
        }
        ...
        {
            return this.Equals(input as AllocStopResponse);
        }

        /// <summary>
        /// Returns true if AllocStopResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AllocStopResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllocStopResponse input)
        {
            if (input == null)
            {
                return false;
