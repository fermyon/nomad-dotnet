...
namespace Fermyon.Nomad.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeploymentUnblockRequest")]
    public partial class DeploymentUnblockRequest : IEquatable<DeploymentUnblockRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentUnblockRequest" /> class.
        /// </summary>
        ...
        public DeploymentUnblockRequest(string deploymentID = default(string), string varNamespace = default(string), string region = default(string), string secretID = default(string))
        {
        ...
        {
            return this.Equals(input as DeploymentUnblockRequest);
        }

        /// <summary>
        /// Returns true if DeploymentUnblockRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeploymentUnblockRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeploymentUnblockRequest input)
        {
            if (input == null)
            {
                return false;
