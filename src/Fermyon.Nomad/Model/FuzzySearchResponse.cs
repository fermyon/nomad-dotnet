...
namespace Fermyon.Nomad.Model
{
    ...
    /// FuzzySearchResponse
    /// </summary>
    [DataContract(Name = "FuzzySearchResponse")]
    public partial class FuzzySearchResponse : IEquatable<FuzzySearchResponse>, IValidatableObject
    {
        ...
        public FuzzySearchResponse(bool knownLeader = default(bool), long lastContact = default(long), int lastIndex = default(int), Dictionary<string, List<FuzzyMatch>> matches = default(Dictionary<string, List<FuzzyMatch>>), string nextToken = default(string), long requestTime = default(long), Dictionary<string, bool> truncations = default(Dictionary<string, bool>))
        {
        ...
        public Dictionary<string, List<FuzzyMatch>> Matches { get; set; }
