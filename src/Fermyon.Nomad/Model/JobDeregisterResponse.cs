...
namespace Fermyon.Nomad.Model
{
    ...
    /// </summary>
    [DataContract(Name = "JobDeregisterResponse")]
    public partial class JobDeregisterResponse : IEquatable<JobDeregisterResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobDeregisterResponse" /> class.
        /// </summary>
        ...
        public JobDeregisterResponse(int evalCreateIndex = default(int), string evalID = default(string), int jobModifyIndex = default(int), bool knownLeader = default(bool), long lastContact = default(long), int lastIndex = default(int), string nextToken = default(string), long requestTime = default(long))
        {
        ...
        {
            return this.Equals(input as JobDeregisterResponse);
        }

        /// <summary>
        /// Returns true if JobDeregisterResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of JobDeregisterResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobDeregisterResponse input)
        {
            if (input == null)
            {
                return false;
