...
namespace Fermyon.Nomad.Model
{
    ...
    /// ACLPolicyListStub
    /// </summary>
    [DataContract(Name = "ACLPolicyListStub")]
    public partial class ACLPolicyListStub : IEquatable<ACLPolicyListStub>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ACLPolicyListStub" /> class.
        /// </summary>
        /// <param name="createIndex">createIndex.</param>
        /// <param name="description">description.</param>
        /// <param name="modifyIndex">modifyIndex.</param>
        /// <param name="name">name.</param>
        public ACLPolicyListStub(int createIndex = default(int), string description = default(string), int modifyIndex = default(int), string name = default(string))
        {
        ...
        {
            return this.Equals(input as ACLPolicyListStub);
        }

        /// <summary>
        /// Returns true if ACLPolicyListStub instances are equal
        /// </summary>
        /// <param name="input">Instance of ACLPolicyListStub to be compared</param>
        /// <returns>Boolean</returns>
