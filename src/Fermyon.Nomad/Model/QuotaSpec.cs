...
namespace Fermyon.Nomad.Model
{
    ...
    /// QuotaSpec
    /// </summary>
    [DataContract(Name = "QuotaSpec")]
    public partial class QuotaSpec : IEquatable<QuotaSpec>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuotaSpec" /> class.
        /// </summary>
        ...
        public QuotaSpec(int createIndex = default(int), string description = default(string), List<QuotaLimit> limits = default(List<QuotaLimit>), int modifyIndex = default(int), string name = default(string))
        {
        ...
        {
            return this.Equals(input as QuotaSpec);
        }

        /// <summary>
        /// Returns true if QuotaSpec instances are equal
        /// </summary>
        /// <param name="input">Instance of QuotaSpec to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuotaSpec input)
        {
            if (input == null)
            {
                return false;
