...
namespace Fermyon.Nomad.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NodeEligibilityUpdateResponse")]
    public partial class NodeEligibilityUpdateResponse : IEquatable<NodeEligibilityUpdateResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeEligibilityUpdateResponse" /> class.
        /// </summary>
        ...
        public NodeEligibilityUpdateResponse(int evalCreateIndex = default(int), List<string> evalIDs = default(List<string>), int lastIndex = default(int), int nodeModifyIndex = default(int), long requestTime = default(long))
        {
        ...
        {
            return this.Equals(input as NodeEligibilityUpdateResponse);
        }

        /// <summary>
        /// Returns true if NodeEligibilityUpdateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of NodeEligibilityUpdateResponse to be compared</param>
        /// <returns>Boolean</returns>
