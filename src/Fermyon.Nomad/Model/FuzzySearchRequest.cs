...
namespace Fermyon.Nomad.Model
{
    ...
    /// FuzzySearchRequest
    /// </summary>
    [DataContract(Name = "FuzzySearchRequest")]
    public partial class FuzzySearchRequest : IEquatable<FuzzySearchRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FuzzySearchRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as FuzzySearchRequest);
        }

        /// <summary>
        /// Returns true if FuzzySearchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FuzzySearchRequest to be compared</param>
        /// <returns>Boolean</returns>
