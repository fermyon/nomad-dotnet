...
namespace Fermyon.Nomad.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CSISnapshotListResponse")]
    public partial class CSISnapshotListResponse : IEquatable<CSISnapshotListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CSISnapshotListResponse" /> class.
        /// </summary>
        ...
        public CSISnapshotListResponse(bool knownLeader = default(bool), long lastContact = default(long), int lastIndex = default(int), string nextToken = default(string), long requestTime = default(long), List<CSISnapshot> snapshots = default(List<CSISnapshot>))
        {
        ...
        {
            return this.Equals(input as CSISnapshotListResponse);
        }

        /// <summary>
        /// Returns true if CSISnapshotListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CSISnapshotListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CSISnapshotListResponse input)
        {
            if (input == null)
                return false;
