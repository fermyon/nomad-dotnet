...
namespace Fermyon.Nomad.Model
{
    ...
    /// ACLToken
    /// </summary>
    [DataContract(Name = "ACLToken")]
    public partial class ACLToken : IEquatable<ACLToken>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ACLToken" /> class.
        /// </summary>
        ...
        public ACLToken(string accessorID = default(string), int createIndex = default(int), DateTime createTime = default(DateTime), bool global = default(bool), int modifyIndex = default(int), string name = default(string), List<string> policies = default(List<string>), string secretID = default(string), string type = default(string))
        {
        ...
        {
            return this.Equals(input as ACLToken);
        }

        /// <summary>
        /// Returns true if ACLToken instances are equal
        /// </summary>
        /// <param name="input">Instance of ACLToken to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ACLToken input)
        {
            if (input == null)
            {
                return false;
