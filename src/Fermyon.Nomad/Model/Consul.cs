...
namespace Fermyon.Nomad.Model
{
    ...
    /// Consul
    /// </summary>
    [DataContract(Name = "Consul")]
    public partial class Consul : IEquatable<Consul>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as Consul);
        }

        /// <summary>
        /// Returns true if Consul instances are equal
        /// </summary>
        /// <param name="input">Instance of Consul to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Consul input)
        {
            if (input == null)
            {
                return false;
