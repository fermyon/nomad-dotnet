...
namespace Fermyon.Nomad.Api
{
    ...
    public partial class PluginsApi : IPluginsApi
    {
        ...
        /// <returns></returns>
        public PluginsApi(Fermyon.Nomad.Client.Configuration configuration)
        {
        ...
        public PluginsApi(Fermyon.Nomad.Client.ISynchronousClient client, Fermyon.Nomad.Client.IAsynchronousClient asyncClient, Fermyon.Nomad.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Fermyon.Nomad.Client.ApiResponse<List<CSIPlugin>> localVarResponse = GetPluginCSIWithHttpInfo(pluginID, region, varNamespace, index, wait, stale, prefix, xNomadToken, perPage, nextToken);
        ...
        {
            Fermyon.Nomad.Client.ApiResponse<List<CSIPlugin>> localVarResponse = await GetPluginCSIWithHttpInfoAsync(pluginID, region, varNamespace, index, wait, stale, prefix, xNomadToken, perPage, nextToken, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Fermyon.Nomad.Client.ApiResponse<List<CSIPluginListStub>> localVarResponse = GetPluginsWithHttpInfo(region, varNamespace, index, wait, stale, prefix, xNomadToken, perPage, nextToken);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<List<CSIPluginListStub>> GetPluginsAsync(string? region = default(string?), string? varNamespace = default(string?), int? index = default(int?), string? wait = default(string?), string? stale = default(string?), string? prefix = default(string?), string? xNomadToken = default(string?), int? perPage = default(int?), string? nextToken = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Fermyon.Nomad.Client.ApiResponse<List<CSIPluginListStub>> localVarResponse = await GetPluginsWithHttpInfoAsync(region, varNamespace, index, wait, stale, prefix, xNomadToken, perPage, nextToken, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
