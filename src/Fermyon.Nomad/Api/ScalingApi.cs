...
namespace Fermyon.Nomad.Api
{
    ...
    public partial class ScalingApi : IScalingApi
    {
        ...
        /// <returns></returns>
        public ScalingApi(Fermyon.Nomad.Client.Configuration configuration)
        {
        ...
        public ScalingApi(Fermyon.Nomad.Client.ISynchronousClient client, Fermyon.Nomad.Client.IAsynchronousClient asyncClient, Fermyon.Nomad.Client.IReadableConfiguration configuration)
        {
